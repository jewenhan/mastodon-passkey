...
Rails.application.routes.draw do
  ...
  devise_scope :user do
    ...
    post 'reauthenticate/new_challenge', to: 'auth/reauthentication#new_challenge', as: :auth_reauthentication_challenge
  ...
  devise_for :users, path: 'auth', format: false, controllers: {
    ...
    pkregistrations:    'auth/pkregistrations',
    pksessions:         'auth/pksessions'
  }
  ...
  get '/root/index', to: 'root#index',format: false
